    ...
    <div className="page-transition min-h-screen pt-28 pb-20">
      <div className="container mx-auto max-w-2xl">
        <div className="text-center mb-12">
          <h1 className="section-title mb-4">Apply for <span className="gradient-text">Admission</span></h1>
          <p className="section-subtitle">Begin your journey at QISCET — Applications open for 2025</p>
        </div>
          ...
          <div className="flex justify-between items-center mb-3">
            {steps.map((step, i) => (
              <div key={step} className="flex flex-col items-center gap-1 flex-1">
                ...
                <span className={`text-xs hidden sm:block ${i === currentStep ? 'text-primary font-medium' : 'text-muted-foreground'}`}>
                  {step}
                </span>
              </div>
            ))}
          ...
          {currentStep === 2 && (
            <div className="space-y-5">
              {['10th Mark Sheet', '12th Mark Sheet', 'Entrance Score Card', 'Passport Photo', 'Aadhar Card'].map(doc => (
                <div key={doc} className="border-2 border-dashed border-border rounded-xl p-5 flex items-center gap-4 hover:border-primary/40 transition-colors group cursor-pointer">
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="text-sm text-muted-foreground">
                  ...
                  <span className="text-primary"> terms and conditions</span> of QISCET.
                </span>
              </label>
            </div>
          )}
